...
写博客有一些年头了，期间域名及博客程序更换过好几次，也曾因为服务器的迁移导致数据丢失很多 ( 主要集中在 05 - 08 年的，服务器从江苏镇江的机房快递到上海移动机房，这台 1U 的服务器后期被我拆了，换了个机箱，至今还在父母家放着 )。博客的名字也随着我更换网名也变很多次。但最后我用了我喜欢的两件事--代码和旅行组成了这个博客名「代码旅行」，代码和旅行亦如我的「诗和远方」。
