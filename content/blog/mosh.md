...
- 需要在服务器端开启 `60000-65535` 的入站端口，比如 aws 的 EC2 -> Security Group，GCP 的 VPC -> Firewall rules。用 GCP 举例

  创建一个 Firewall rule，大致步骤如下
  ...
  然后在要开启的 vm 的 networking 里增加 mosh 这个 tag 即可。
